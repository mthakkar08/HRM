...
//192.168.1.106:8080/hrm/employee/list?employeeName=sagar&designation=&status=&email=

export async function getEmployeeDetail(employeeId) {

  return axios.get(apiUrl + "/fueltype/get?employeeId=" + employeeId).then((response) => response.data);
}
