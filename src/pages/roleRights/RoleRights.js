...
// import { getManageRoleRightsList, deleteManageRoleRights, updateManageRoleRightsStatus} from "../../services/ManageRoleRightsServices.js";
...
//     setLoading(true);
//     try {
//       await deleteManageRoleRights(currentemployeeId).then(res => { message = res });
//     }
//     catch (error) {
...
//   //   setLoading(true);
//   //   try {
//   //     await updateManageRoleRightsStatus(employeeId, status).then(res => { message = res });
//   //   }
//   //   catch (error) {
//   //     message = error.message;
//   //   }
...
//     setEmail("");
//     await getManageRoleRightsList("", "", "", "").then(res => { setEmployeeList(res) });
...
//                   <Form.Label className='display-inline search-label'>Menu</Form.Label>
